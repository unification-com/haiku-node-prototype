...
RUN /tmp/build/bin/eosiocpp -o unification_uapp.wast unification_uapp.cpp && \
    /tmp/build/bin/eosiocpp -g unification_uapp.abi unification_uapp.cpp
...
RUN echo "/tmp/build/bin/eosiocpp -o unification_uapp.wast unification_uapp.cpp" >> /root/.bash_history && \
    ...
    echo "/tmp/build/bin/eosiocpp -o unification_mother.wast unification_mother.cpp" >> /root/.bash_history && \
    echo "/tmp/build/bin/eosiocpp -g unification_mother.abi unification_mother.cpp" >> /root/.bash_history && \
    echo "/tmp/build/bin/eosiocpp -o eosio.token.wast eosio.token.cpp" >> /root/.bash_history && \
    echo "/tmp/build/bin/eosiocpp -g eosio.token.abi eosio.token.cpp" >> /root/.bash_history
