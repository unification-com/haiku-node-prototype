...
def spawn_haiku_node(pw, conf):
    ...
    ks.set_encryption_key("user1", "app2", "EOS4yMT6jNNsrsSxX26xeVCjQkqsUUiMzCEaHCTvLo5tR1JmBuE3C")
    ks.set_encryption_key("user1", "app3", "EOS74UxTtX4mY1d716PkMSi3B9r97yseB9ogHvohdjmT8r8emnFTz")
